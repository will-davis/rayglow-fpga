...
Pi 5: rayglow renderer (GLSL/EGL, unchanged) ──▶ KMS DPI out, GPIO0–27
        RGB888 + PCLK/DE/syncs, custom modeline ~3.5 MHz @ 60 Hz
...
## Status
- 2026-07-18: project created. Plan (ROADMAP.md) + interface contract drafted; Amaranth
  skeleton simulating under uv. Next: Phase 0 toolchain install.
...
- `hardware/` — topic docs (current truth), later the wing-board KiCad project
